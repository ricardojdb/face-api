...
while True:
    ...
    for face in detections:
        ...
        if confidence > 0.3:
            ...
            # Expand the bounding box to capture the entire head this improves
            # the performance of gender, age and sentiment models
            ...
            roi_color = img[max(ymin, 0):min(ymax, h-1),
                            max(xmin, 0):min(xmax, w-1)]
