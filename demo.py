...
while True:
    ...
    for face in detections:
        ...
        if confidence > 0.3:
            ...
            xmin, ymin, xmax, ymax = max(xmin,0), max(ymin,0), min(xmax,w-1), min(ymax, h-1)
            ...
            xmin_wide, ymin_wide, xmax_wide, ymax_wide = utils.get_wide_box(w, h, xmin, ymin, xmax, ymax)
            ...
            if label in table_dict:
                ...
                table_dict[label] = [label, gender, age, *scores, [xmin, ymin, xmax, ymax], time_stamp]
